...
<head>
  ...
  <title>Operator - Reserved Rooms</title>
...
<body>                      <!--   BODY BODY BODY    -->
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <h1 class="mt-4">  Reserved Rooms  </h1>
        
        <?php

            $qry = " SELECT room_id,status,room_type FROM room INNER JOIN category ON room.cat_fk = category.cat_id  WHERE status = 'reserved' ";
            ...
            if($res->num_rows > 0)
            {
                ...
                $result .= " <tr> <th class='table-dark'>Room </th> <th class='table-dark'>Category</th> <th class='table-dark'>Status</th> </tr> ";
