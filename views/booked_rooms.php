...
<head>
  ...
  <title>Operator - Booked Rooms</title>
...
<body>                      <!--   BODY BODY BODY    -->
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <h1 class="mt-4">  Booked Rooms  </h1>
        <!-- TABLE  -->
        <?php

            $qry = " SELECT room_id,status,room_type FROM room INNER JOIN category ON room.cat_fk = category.cat_id  WHERE status = 'booked' ";
